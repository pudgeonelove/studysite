...
Статичный сайт для GitHub Pages: материалы 9 класса, мини-тесты и отдельная страница подготовки к госэкзамену по истории Кыргызстана.

## Файлы сайта

- `index.html` - главная страница с предметами, темами и тестами.
- `history-exam.html` - подготовка к госэкзамену по истории Кыргызстана.
